...
| --- | --- | --- | --- | --- |
| [EXP-003](EXP-003-default-language-report.md) | Does reporting default English restore truthful language-filter metadata? | supported | Language metadata coverage 33.33% to 100%; +4.27% bytes; other fields identical. | Pending implementation validation; not shipped |

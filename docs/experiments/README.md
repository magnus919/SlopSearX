...
| --- | --- | --- | --- | --- |
| [EXP-014](EXP-014-jev-specialist-threshold-value.md) | At what Jev score does another specialist request add enough evidence to justify its cost? | preregistered | Dense 0.45-0.65 curve; three-level relevance; one 30-query union acquisition replayed across thresholds. | None |

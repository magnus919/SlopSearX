...
| --- | --- | --- | --- | --- |
| [EXP-021](EXP-021-jev-card-triage-brave-e2e.md) | Does Jev improve additive quality triage on actual Brave-backed cards, including prompt-injection controls? | registered | Bounded Brave retry of EXP-018; labels and Jev run pending. | None |
| [EXP-020](EXP-020-jev-next-source-brave-e2e.md) | Does Jev improve realized next-source value after a Brave-backed first pass? | registered | Bounded Brave retry of EXP-017; labels and Jev run pending. | None |
| [EXP-019](EXP-019-jev-annotations-brave-e2e.md) | Does Jev improve multi-label annotations on actual Brave-backed result cards? | registered | Bounded Brave retry of EXP-016; labels and Jev run pending. | None |

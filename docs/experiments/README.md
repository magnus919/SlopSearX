...
| --- | --- | --- | --- | --- |
| [EXP-015](EXP-015-jev-advisory-calibration.md) | Do calibrated Jev scores improve additive multi-label annotations, next-source advice, and result-card quality triage on synthetic holdout cases? | registered | Pending frozen calibration and holdout run; no paid search calls. | None |

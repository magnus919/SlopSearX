...
| --- | --- | --- | --- | --- |
| [EXP-004](EXP-004-jev-official-doc-rerank.md) | Can a bounded Jev rerank materially improve official-documentation navigation over presence/RRF? | registered | Frozen 12-query MRR@20 pilot for issue #389; no measured calls yet. | Not authorized |

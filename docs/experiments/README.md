...
| --- | --- | --- | --- | --- |
| [EXP-002](EXP-002-empty-query-fast-path.md) | Does skipping empty query processing reduce shared-service latency meaningfully? | registered | Pending fixed offline comparison | None |

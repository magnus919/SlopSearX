...
| --- | --- | --- | --- | --- |
| [EXP-011](EXP-011-jev-per-engine-routing.md) | Can batched Jev per-engine decisions improve bounded engine routing over the deterministic router? | preregistered | 51 routing cards, 12 development queries, 30 held-out queries, fixed gates and paid-search ceilings; no measurements yet. | None |

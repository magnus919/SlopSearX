...
| --- | --- | --- | --- | --- |
| [EXP-001](EXP-001-results-only.md) | Can results-only MCP output save >=10% bytes without losing interpretation facts? | blocked | Healthy pairs: 6.45% smaller but outcome facts lost; full comparison stopped on transport failure. | None |

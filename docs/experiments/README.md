...
| --- | --- | --- | --- | --- |
| [EXP-001](EXP-001-results-only.md) | Can results-only MCP output save >=10% bytes without losing interpretation facts? | registered | Pending paired fixture comparison | None |

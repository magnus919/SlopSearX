...
| --- | --- | --- | --- | --- |
| [EXP-025](EXP-025-captured-ranking.md) | Does opt-in RRF improve captured-query nDCG@10 over presence? | registered | Corpus eligibility audit before replay. | None |

...
TOOL_DEFINITIONS: tuple[ToolDefinition, ...] = (
    ...
    _definition(
        tools.slopsearx_read_saved_search_events,
        contract="slopsearx.saved_search_event_batch",
        grants=("saved_search_events",),
        state=StateRequirement.DURABLE,
        sensitive=_REVALIDATED_SCOPE,
        policy_gate=True,
        docs="docs/SAVED_SEARCH_EVENTS.md",
        transport_test="tests/test_saved_events_transport.py",
    ),
    _definition(
        tools.slopsearx_ack_saved_search_events,
